...
- **WD** — resolves on-site redirects into filecrypt protected links via `detect_crypter_type`, with a FlareSolverr fallback on Cloudflare challenges; browser redirect resolution enables FileCrypt document-start protection.
