...
def _search_single_page(shared_state, host, search_string, search_id, page_num, imdb_id, mirror, request_from, season, episode):
    """
...
def dl_search(shared_state, start_time, request_from, search_string,
    ...
    info(f"{hostname}: Starting parallel paginated search for '{search_string}' (Season: {season}, Episode: {episode}) - up to {max_pages} pages")
