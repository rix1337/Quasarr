...
class Source(AbstractSearchSource):
    ...
    # The source has no native discovery endpoint, so the feed seeds from the
    # *arr libraries: monitored movies from Radarr, and missing episodes from
    # Sonarr (which supply the season+episode the API requires per request).
    ...
    def feed(
        ...
        # the *arr libraries: monitored movies from Radarr, and missing episodes
        # (with their season+episode) from Sonarr.
